...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |    |Alt |Gui |      Space             |Fn1 |Alt  |   |    |
     * `-----------------------------------------------------------'
     */
    KEYMAP_HHKB(
        FN3, 1,   2, FN2,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, BSLS, GRV, \
        TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSPC,      \
        LCTL,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,     ENT,       \
        LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM, DOT, SLSH,    RSFT,FN0,       \
        NO,  LALT,LGUI,          SPC,                     FN1, RALT, NO, NO),
    ...
    KEYMAP_HHKB(
        ...
        TRNS,FN4,FN5,FN6,TRNS,TRNS,PPLS,PMNS,END, PGDN,DOWN,     TRNS,TRNS,      \
        TRNS,TRNS,TRNS,          TRNS,                    TRNS,TRNS,TRNS,TRNS),
    
    /* 2: FN1 vim layer for MOMENTARY
     * ,-----------------------------------------------------------.
     * |   |   |   |   |END|   |HOME|  |   |   |HOME|   |  |  |    |
     * |-----------------------------------------------------------|
     * | FN7 |   |   |   |   |   |   |PgU |INS|   |   |   |   |Bspc|
     * |-----------------------------------------------------------|
     * |      |   |  |PgD |    |   |Left|Down|Up|Right|  |  |      |
     * |-----------------------------------------------------------|
     * | Shift  |   |DEL|   |    |   |   |   |   |   |   |     |   |
     * |-----------------------------------------------------------|
     * |    |    | Alt|                        |    |    |    |    |
     ...
     */
    KEYMAP_HHKB(
        TRNS, TRNS,TRNS,TRNS, END,TRNS,HOME,TRNS,TRNS,TRNS,HOME,TRNS,TRNS,TRNS,TRNS, \
        FN7,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PGUP, INS,TRNS,TRNS, TRNS,TRNS,BSPC,      \
        TRNS,TRNS,TRNS,PGDN,TRNS,TRNS,LEFT,DOWN,  UP,RGHT,TRNS,TRNS,    TRNS,      \
        LSFT,   TRNS,DEL,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,   TRNS, TRNS,      \
        TRNS,TRNS,LALT,            TRNS,                  TRNS,TRNS,TRNS,TRNS),

    /* 3: FN7 vim layer for keep
     * ,-----------------------------------------------------------.
     * |FN8|   |   |   |END|   |HOME|  |   |   |HOME|   |  |  |    |
     * |-----------------------------------------------------------|
     * |     |   |   |   |   |   |   |PgU |INS|   |   |   |   |Bspc|
     ...
     */
    KEYMAP_HHKB(
        FN8, TRNS,TRNS,TRNS, END,TRNS,HOME,TRNS,TRNS,TRNS,HOME,TRNS,TRNS,TRNS,TRNS, \
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PGUP, INS,TRNS,TRNS, TRNS,TRNS,BSPC,      \
        TRNS,TRNS,TRNS,PGDN,TRNS,TRNS,LEFT,DOWN,  UP,RGHT,TRNS,TRNS,    TRNS,      \
        LSFT,   TRNS,DEL,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,   TRNS, TRNS,      \
        TRNS,TRNS,LALT,            TRNS,                  TRNS,TRNS,TRNS,TRNS),
};
